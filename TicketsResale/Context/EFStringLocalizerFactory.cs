                ...
                _db.AddRange(
                    new Culture
                    {
                        ...
                        Resources = new List<Resource>()
                        {
                            ...
                            new Resource { Key = "Create ticket", Value = "Create ticket" },
                            new Resource { Key = "Name", Value = "Name" },
                            new Resource { Key = "Event", Value = "Event" },
                            new Resource { Key = "Price", Value = "Price" },
                            new Resource { Key = "Seller", Value = "Seller" },
                            new Resource { Key = "Status", Value = "Status" },
                            new Resource { Key = "Track/Reason", Value = "Track/Reason" },
                            new Resource { Key = "Cart is empty", Value = "Cart is empty" },
                            new Resource { Key = "Create a new account.", Value = "Create a new account." },
                            new Resource { Key = "Use another service to register.", Value = "Use another service to register." },
                            new Resource { Key = "Register", Value = "Register" },
                            new Resource { Key = "Log in", Value = "Log in" },
                            new Resource { Key = "Selling", Value = "Selling" },
                            new Resource { Key = "Waiting Confirmation", Value = "Waiting Confirmation" },
                            new Resource { Key = "Sold", Value = "Sold" },
                            new Resource { Key = "Date", Value = "Date" },
                            new Resource { Key = "Confirm", Value = "Confirm" },
                            new Resource { Key = "Reject", Value = "Reject" },
                            new Resource { Key = "Confirmation of ticket", Value = "Confirmation of ticket" },
                            new Resource { Key = "Confirm or reject ticket", Value = "Confirm or reject ticket" },
                            new Resource { Key = "textReject", Value = "To confirm the ticket, click on the checkbox, to reject - leave it blank" },
                            new Resource { Key = "textReason", Value = "Enter the track number if you confirmed the ticket, or enter the reason if you declined the ticket" },
                            new Resource { Key = "Admin panel", Value = "Admin panel" },
                            new Resource { Key = "adminText1", Value = "Here you can edit data of the site TicketsResale." },
                            new Resource { Key = "adminText2", Value = "By clicking on the corresponding button you will be redirected to the data editing page." },
                            new Resource { Key = "Manage users rights", Value = "Manage users rights" },
                            new Resource { Key = "Address", Value = "Address" },
                            new Resource { Key = "Description", Value = "Description" },
                            new Resource { Key = "Role", Value = "Role" },
                            new Resource { Key = "Manage your account", Value = "Manage your account" },
                            new Resource { Key = "Change your account settings", Value = "Change your account settings" },
                            new Resource { Key = "Profile", Value = "Profile" },
                            new Resource { Key = "Email", Value = "Email" },
                            new Resource { Key = "Password", Value = "Password" },
                            new Resource { Key = "Two-factor authentication", Value = "Two-factor authentication" },
                            new Resource { Key = "Personal data", Value = "Personal data" },
                            new Resource { Key = "External logins", Value = "External logins" },
                    ...
                    new Culture
                    {
                        ...
                        Resources = new List<Resource>()
                        {
                            ...
                            new Resource { Key = "Create ticket", Value = "Создать билет" },
                            new Resource { Key = "Name", Value = "Имя" },
                            new Resource { Key = "Event", Value = "Событие" },
                            new Resource { Key = "Price", Value = "Цена" },
                            new Resource { Key = "Seller", Value = "Продавец" },
                            new Resource { Key = "Status", Value = "Статус" },
                            new Resource { Key = "Track/Reason", Value = "Трек/Причина" },
                            new Resource { Key = "Cart is empty", Value = "Корзина пуста" },
                            new Resource { Key = "Create a new account.", Value = "Создать новый аккаунт." },
                            new Resource { Key = "Use another service to register.", Value = "Используйте другой сервис для регистрации." },
                            new Resource { Key = "Register", Value = "Зарегистрироваться" },
                            new Resource { Key = "Log in", Value = "Войти" },
                            new Resource { Key = "Selling", Value = "На продаже" },
                            new Resource { Key = "Waiting Confirmation", Value = "Ожидают подтверждения" },
                            new Resource { Key = "Sold", Value = "Проданы" },
                            new Resource { Key = "Date", Value = "Дата" },
                            new Resource { Key = "Confirm", Value = "Подтвердить" },
                            new Resource { Key = "Reject", Value = "Отклонить" },
                            new Resource { Key = "Confirmation of ticket", Value = "Подтверждение билета" },
                            new Resource { Key = "Confirm or reject ticket", Value = "Подтвердите или отклоните билет" },
                            new Resource { Key = "textReject", Value = "Для подтверждения билета нажмите на флажок, для отклонения - оставьте пустым" },
                            new Resource { Key = "textReason", Value = "Введите трек номер, если вы подтвердили билет, или введите причину, если вы отклонили билет" },
                            new Resource { Key = "Admin panel", Value = "Панель администратора" },
                            new Resource { Key = "adminText1", Value = "Здесь вы можете редактировать данные сайта TicketsResale." },
                            new Resource { Key = "adminText2", Value = "Нажав на соответствующую кнопку, вы будете перенаправлены на страницу редактирования данных." },
                            new Resource { Key = "Manage users rights", Value = "Редактирование прав пользователей" },
                            new Resource { Key = "Address", Value = "Адрес" },
                            new Resource { Key = "Description", Value = "Описание" },
                            new Resource { Key = "Role", Value = "Роль" },
                            new Resource { Key = "Manage your account", Value = "Управляйте своим аккаунтом" },
                            new Resource { Key = "Change your account settings", Value = "Изменяйте настроки аккаунта" },
                            new Resource { Key = "Profile", Value = "Профиль" },
                            new Resource { Key = "Email", Value = "Емэйл" },
                            new Resource { Key = "Password", Value = "Пароль" },
                            new Resource { Key = "Two-factor authentication", Value = "Двухфакторная аутентификация" },
                            new Resource { Key = "Personal data", Value = "Персональные данные" },
                            new Resource { Key = "External logins", Value = "Внешние логины" },
                            new Resource { Key = "", Value = "" },
                            new Resource { Key = "", Value = "" },
                        }
                    },
                    new Culture
                    {
                        ...
                        Resources = new List<Resource>()
                        {
                            ...
                            new Resource { Key = "Create ticket", Value = "Стварыць квіток" },
                            new Resource { Key = "Name", Value = "Iмя" },
                            new Resource { Key = "Event", Value = "Падзея" },
                            new Resource { Key = "Price", Value = "Цана" },
                            new Resource { Key = "Seller", Value = "Прадавец" },
                            new Resource { Key = "Status", Value = "Статус" },
                            new Resource { Key = "Track/Reason", Value = "Трэк/Прычына" },
                            new Resource { Key = "Cart is empty", Value = "Кошык пусты" },
                            new Resource { Key = "Create a new account.", Value = "Стварыць новы акаўнт." },
                            new Resource { Key = "Use another service to register.", Value = "Для рэгiстрацыi выкарыстоўвайце іншую службу." },
                            new Resource { Key = "Register", Value = "Зарэгістравацца" },
                            new Resource { Key = "Log in", Value = "Увайсцi" },
                            new Resource { Key = "Selling", Value = "На продажы" },
                            new Resource { Key = "Waiting Confirmation", Value = "Чакаюць пацверджання" },
                            new Resource { Key = "Sold", Value = "Прададзены" },
                            new Resource { Key = "Date", Value = "Дата" },
                            new Resource { Key = "Confirm", Value = "Пацвердзіць" },
                            new Resource { Key = "Reject", Value = "Адхіліць" },
                            new Resource { Key = "Confirmation of ticket", Value = "Пацверджанне білета" },
                            new Resource { Key = "Confirm or reject ticket", Value = "Пацвердзіце альбо адхіліце білет" },
                            new Resource { Key = "textReject", Value = "Для пацверджання білета націсніце на сцяжок, для адхілення - пакіньце пустым" },
                            new Resource { Key = "textReason", Value = "Увядзіце трэк нумар, калі вы пацвердзіце білет, альбо ўвядзіце прычыну, калі вы адкланіце білет" },
                            new Resource { Key = "Admin panel", Value = "Панэль адміністратара" },
                            new Resource { Key = "adminText1", Value = "Тут вы можаце рэдагаваць дадзеныя сайта TicketsResale." },
                            new Resource { Key = "adminText2", Value = "Націснуўшы на адпаведную кнопку, вы будзеце перанакіраваны на старонку рэдагавання дадзеных." },
                            new Resource { Key = "Manage users rights", Value = "Кіраванне правамі карыстальнікаў" },
                            new Resource { Key = "Address", Value = "Адрас" },
                            new Resource { Key = "Description", Value = "Апiсанне" },
                            new Resource { Key = "Role", Value = "Роля" },
                            new Resource { Key = "Manage your account", Value = "Кіруйце сваім аккаунтам" },
                            new Resource { Key = "Change your account settings", Value = "Змяніце параметры аккаунта" },
                            new Resource { Key = "Profile", Value = "Профіль" },
                            new Resource { Key = "Email", Value = "Емэйл" },
                            new Resource { Key = "Password", Value = "Пароль" },
                            new Resource { Key = "Two-factor authentication", Value = "Двухфактарная аўтэнтыфікацыя" },
                            new Resource { Key = "Personal data", Value = "Асабістыя дадзеныя" },
                            new Resource { Key = "External logins", Value = "Знешнія лагіны" },
                            new Resource { Key = "", Value = "" },
                            new Resource { Key = "", Value = "" },
                        }
                    }
