                ...
                _db.AddRange(
                    new Culture
                    {
                        ...
                        Resources = new List<Resource>()
                        {
                            ...
                            new Resource { Key = "City", Value = "City" },
                            new Resource { Key = "Category", Value = "Category" },
                            new Resource { Key = "DateFrom", Value = "Date from" },
                            new Resource { Key = "DateTo", Value = "Date to" },
                            new Resource { Key = "SortBy", Value = "Sort by" },
                            new Resource { Key = "SortOrder", Value = "Sort order" },
                            new Resource { Key = "PageSize", Value = "Display by" },
                            new Resource { Key = "Search", Value = "Search" },
                    ...
                    new Culture
                    {
                        ...
                        Resources = new List<Resource>()
                        {
                            ...
                            new Resource { Key = "City", Value = "Город" },
                            new Resource { Key = "Category", Value = "Категория" },
                            new Resource { Key = "DateFrom", Value = "Дата с" },
                            new Resource { Key = "DateTo", Value = "Дата по" },
                            new Resource { Key = "SortBy", Value = "Сортировать по" },
                            new Resource { Key = "SortOrder", Value = "Порядок сортировки" },
                            new Resource { Key = "PageSize", Value = "Отображать по" },
                            new Resource { Key = "Search", Value = "Найти" },
                            new Resource { Key = "", Value = "" },
                            new Resource { Key = "", Value = "" },
                            new Resource { Key = "", Value = "" },
                            new Resource { Key = "", Value = "" },
                    ...
                    new Culture
                    {
                        ...
                        Resources = new List<Resource>()
                        {
                            ...
                            new Resource { Key = "City", Value = "Горад" },
                            new Resource { Key = "Category", Value = "Катэгорыя" },
                            new Resource { Key = "DateFrom", Value = "Дата з" },
                            new Resource { Key = "DateTo", Value = "Дата да" },
                            new Resource { Key = "SortBy", Value = "Cартаваць па" },
                            new Resource { Key = "SortOrder", Value = "Парадак сартавання" },
                            new Resource { Key = "PageSize", Value = "Адлюстроўваць па" },
                            new Resource { Key = "Search", Value = "Знайсцi" },
                            new Resource { Key = "", Value = "" },
                            new Resource { Key = "", Value = "" },
                            new Resource { Key = "", Value = "" },
                            new Resource { Key = "", Value = "" },
